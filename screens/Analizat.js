...
const Analizat = ({navigation}) => {
  const [selectedAnalysis, setSelectedAnalysis] = useState(null);

  const analysisData = [
    { date: '01-03-2023', type: 'Analizat e gjakut', photo: require('./images/analysis-example.jpg') },
    { date: '02-04-2023', type: 'Biopsia', photo: require('./images/analysis-example.jpg') },
    { date: '04-05-2023', type: 'Check-up', photo: require('./images/analysis-example.jpg') },
  ];
  ...
  return (
    ...
    <View style={styles.titleContainer}>
      <Text style={styles.title}>Analizat tuaja mund t'i gjeni me poshte</Text>
